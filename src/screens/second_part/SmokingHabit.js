...
const smokingHabits = ({navigation}) => {
  ...
  const selectSmokeHabit = habit => {
    setSelectedSmokeHabit(habit);
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subTitle}>Their smokinging habits</Text>
      ...
      <View style={styles.choicesContainer}>
        {smokingHabits.map(habit => (
          <ChoiceButton
            key={habit}
            label={habit}
            isSelected={selectedSmokeHabit === habit}
            onSelect={() => selectSmokeHabit(habit)}
